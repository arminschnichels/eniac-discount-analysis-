...
- **Decision:** Removed all orders containing at least one corrupted price row
- **Rationale:** Keeping partial orders would skew revenue and discount calculations
- **Result:** 216,250 rows retained after cleaning
